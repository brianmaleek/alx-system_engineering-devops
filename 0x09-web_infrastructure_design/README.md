...
## Project to be done in teams of 3 people (your team: Brian Kinyanjui, Esther Wachuka)
...
- You must be able to explain some specifics about this infrastructure:
  ...
  - What type of DNS record `www` is in `<foobar.com>`
...
On a whiteboard, design a three server web infrastructure that hosts the website `<foobar.com>`.
...
- You must add:
  - 3 firewalls
  - 1 SSL certificate to serve `<foobar.com>` over HTTPS
